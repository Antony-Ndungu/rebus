...
var _TopContainer = __webpack_require__(899);

var _TopContainer2 = _interopRequireDefault(_TopContainer);

var _Sidebar = __webpack_require__(900);

var _Sidebar2 = _interopRequireDefault(_Sidebar);

var _Overlay = __webpack_require__(901);
...
var _Main = __webpack_require__(902);
...
var Dashboard = function (_Component) {
    ...
    function Dashboard() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Dashboard.__proto__ || Object.getPrototypeOf(Dashboard)).call.apply(_ref, [this].concat(args))), _this), _this.decoded = _jsonwebtoken2.default.decode(_this.props.token, { complete: true }), _this.socket = (0, _socket2.default)(), _this.saveNavigation = function () {
            localStorage.setItem("dashboardNavigator", _this.props.dashboardNavigator);
    ...
    _createClass(Dashboard, [{
        ...
        value: function componentWillMount() {
            var dashboardNavigator = Number(localStorage.getItem("dashboardNavigator"));
...
var AsyncOverview = (0, _AsyncComponent2.default)(function () {
    return __webpack_require__.e/* import() */(6).then(__webpack_require__.bind(null, 903));
});
var AsyncPayments = (0, _AsyncComponent2.default)(function () {
    return __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 906));
});
