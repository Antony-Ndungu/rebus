...
var Dashboard = function (_Component) {
    ...
    _createClass(Dashboard, [{
        ...
        value: function componentDidMount() {
            ...
            _axios2.default.get("/api/customers-count?businessShortcode=" + businessShortcode).then(function (_ref2) {
                var data = _ref2.data;
                ...
                if (data.confirmation === "success") {
                    _this2.props.setCustomersNumber(+data.count);
                    _axios2.default.get("/api/payments-count?businessShortcode=" + businessShortcode).then(function (_ref3) {
                        var data = _ref3.data;
