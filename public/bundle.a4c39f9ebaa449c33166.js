...
var binary = __webpack_require__(686);
var isBuf = __webpack_require__(282);
...
var hasCORS = __webpack_require__(690);
...
var SET_ACCOUNT_BALANCE = exports.SET_ACCOUNT_BALANCE = "SET_ACCOUNT_BALANCE";
var SEARCH_PAYMENTS = exports.SEARCH_PAYMENTS = "SEARCH_PAYMENTS";
var START_FETCHING = exports.START_FETCHING = "START_FETCHING";
var STOP_FETCHING = exports.STOP_FETCHING = "STOP_FETCHING";
...
exports.navigateDashboard = exports.resetPasswordReset = exports.resetPassword = exports.resetMerchantPassword = exports.closeSidebar = exports.openSidebar = exports.setAccountBalance = exports.setPaymentsNumber = exports.setCustomersNumber = exports.merchantLogout = exports.searchPayments = exports.merchantLogin = undefined;
...
var searchPayments = exports.searchPayments = function searchPayments(query) {
    query = _queryString2.default.stringify(query);
    return function (dispatch) {
        dispatch({
            type: _constants.START_FETCHING
        });
        _axios2.default.get("/api/paginated-payments?" + query).then(function (_ref) {
            var data = _ref.data;

            dispatch({
                type: _constants.STOP_FETCHING
            });
            if (data.confirmation === "success") {
                dispatch({
                    type: _constants.SEARCH_PAYMENTS,
                    payload: data.result
                });
...
var setAccountBalance = exports.setAccountBalance = function setAccountBalance(amount) {
    return {
        type: _constants.SET_ACCOUNT_BALANCE,
        payload: amount
    };
};
...
var eio = __webpack_require__(688);
var Socket = __webpack_require__(287);
var Emitter = __webpack_require__(68);
...
var Backoff = __webpack_require__(702);
...
var XMLHttpRequest = __webpack_require__(166);
var XHR = __webpack_require__(691);
var JSONP = __webpack_require__(698);
var websocket = __webpack_require__(699);
...
var parser = __webpack_require__(165);
var Emitter = __webpack_require__(68);
var toArray = __webpack_require__(701);
var on = __webpack_require__(288);
var bind = __webpack_require__(289);
...
var url = __webpack_require__(683);
var parser = __webpack_require__(165);
...
exports.Socket = __webpack_require__(287);
...
var _PrivateRoute = __webpack_require__(535);
...
var _SuccessAlert = __webpack_require__(301);
...
var AsyncForgotPassword = (0, _AsyncComponent2.default)(function () {
    return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 768));
});
var AsyncResetPassword = (0, _AsyncComponent2.default)(function () {
    return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 769));
});
var AsyncDashboard = (0, _AsyncComponent2.default)(function () {
    return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 770));
});
var AsyncSucessAlert = (0, _AsyncComponent2.default)(function () {
    return new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 301));
});
...
var parseuri = __webpack_require__(280);
 ...
 *
 */
module.exports.parser = __webpack_require__(69);
...
Socket.parser = __webpack_require__(69);
...
var keys = __webpack_require__(692);
var hasBinary = __webpack_require__(281);
var sliceBuffer = __webpack_require__(693);
var after = __webpack_require__(694);
var utf8 = __webpack_require__(695);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(696);
}
...
var Blob = __webpack_require__(697);
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(700);
  } catch (e) { }
}
...
var decodeComponent = __webpack_require__(705);
...
var _FormControl = __webpack_require__(303);
...
var _validation = __webpack_require__(305);
...
var _reduxLogger = __webpack_require__(763);
...
var _reduxDevtoolsExtension = __webpack_require__(764);
...
var _merchantReducer = __webpack_require__(762);
...
exports.default = function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { isAuthenticated: false, token: null, fetching: false, payments: { docs: [], pages: 0 }, accountBalance: "0", displaySidebar: false, dashboardNavigator: 0, paymentsNumber: 0, customersNumber: 0, passwordReset: { emailSent: false, message: null } };
