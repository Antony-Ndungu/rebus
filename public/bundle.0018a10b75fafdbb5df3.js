...
var hasCORS = __webpack_require__(584);
...
var eio = __webpack_require__(582);
...
var XHR = __webpack_require__(585);
var JSONP = __webpack_require__(592);
var websocket = __webpack_require__(593);
...
var parser = __webpack_require__(152);
var Emitter = __webpack_require__(66);
var toArray = __webpack_require__(595);
var on = __webpack_require__(245);
var bind = __webpack_require__(246);
...
var _PrivateRoute = __webpack_require__(534);
...
var _socket = __webpack_require__(576);
...
var _Login = __webpack_require__(597);

var _Login2 = _interopRequireDefault(_Login);

var _SuccessAlert = __webpack_require__(258);
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            this.socket.on("new payment", function (data) {
                _this2.props.setPaymentsNubmer(data.count);
            });
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reactRouterDom.Route, { path: "/forgot-password", render: function render() {
                        return _this3.props.passwordReset.emailSent ? _react2.default.createElement(AsyncSucessAlert, { subject: "Email sent!", message: _this3.props.passwordReset.message }) : _react2.default.createElement(AsyncForgotPassword, null);
                    } }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return (0, _redux.bindActionCreators)({ resetPasswordReset: _merchantActions.resetPasswordReset, setCustomersNumber: _merchantActions.setCustomersNumber, setPaymentsNubmber: setPaymentsNubmber }, dispatch);
};

App.propTypes = {
    resetPasswordReset: _propTypes2.default.func.isRequired,
    setCustomersNumber: _propTypes2.default.func.isRequired,
    setPaymentsNubmber: _propTypes2.default.func.isRequired
};
...
var url = __webpack_require__(577);
var parser = __webpack_require__(152);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(101)(module), __webpack_require__(9)))
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(594);
  } catch (e) { }
}
...
var _validation = __webpack_require__(303);
...
var sliceBuffer = __webpack_require__(587);
var after = __webpack_require__(588);
var utf8 = __webpack_require__(589);
...
var Blob = __webpack_require__(591);
...
exports.default = function () {
    ...
    switch (action.type) {
        ...
        case _constants.SET_CUSTOMERS_NUMBER:
            state = Object.assign({}, state, { customerNumber: action.payload });
            break;
